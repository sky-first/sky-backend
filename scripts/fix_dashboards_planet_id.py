...
async def fix_dashboards_planet_id():
    ...
    database_url = os.getenv('DATABASE_URL', 'postgresql+asyncpg://postgres:password@localhost:5433/ai_saas_db')
    ...
    try:
        ...
        if 'planet_id' in column_names:
            ...
            print("❌ Neither workspace_id nor planet_id found. Table may not exist or have different structure.")
