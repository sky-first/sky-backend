...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_ai_history_user_date", "ai_history", ["user_id", "date"], unique=False
    )
    ...
    op.create_index(
        "idx_ai_queries_widget_id", "ai_queries", ["widget_id"], unique=False
    )
    op.create_index("idx_ai_queries_status", "ai_queries", ["status"], unique=False)
    op.create_index(
        "idx_ai_queries_created_at", "ai_queries", ["created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_pipelines_started_at", "pipelines", ["started_at"], unique=False
    )
    ...
    op.create_index(
        "idx_chat_messages_widget_id", "chat_messages", ["widget_id"], unique=False
    )
    op.create_index(
        "idx_chat_messages_timestamp", "chat_messages", ["timestamp"], unique=False
    )
    ...
    op.create_index(
        "idx_ai_responses_widget_id", "ai_responses", ["widget_id"], unique=False
    )
    op.create_index(
        "idx_ai_responses_is_active", "ai_responses", ["is_active"], unique=False
    )
    op.create_index(
        "idx_ai_responses_timestamp", "ai_responses", ["timestamp"], unique=False
    )
