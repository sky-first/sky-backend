...
def downgrade() -> None:
    ...
    op.create_index(
        "idx_audit_prompt_injection",
        "query_audit_log",
        ["prompt_injection_detected"],
        unique=False,
        postgresql_where="(prompt_injection_detected = true)",
    )
    op.create_index(
        "idx_audit_pii_detected",
        "query_audit_log",
        ["pii_detected_in_prompt", "pii_detected_in_response"],
        unique=False,
        postgresql_where="((pii_detected_in_prompt = true) OR (pii_detected_in_response = true))",
    )
    op.create_index(
        "idx_audit_pii_blocked",
        "query_audit_log",
        ["pii_blocked"],
        unique=False,
        postgresql_where="(pii_blocked = true)",
    )
    op.create_index(
        "idx_audit_escalation",
        "query_audit_log",
        ["progressive_escalation_detected"],
        unique=False,
