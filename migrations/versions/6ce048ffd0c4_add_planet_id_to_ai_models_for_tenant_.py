...
def upgrade() -> None:
    ...
    if not _index_exists("idx_ai_history_planet_id"):
        op.create_index(
            "idx_ai_history_planet_id", "ai_history", ["planet_id"], unique=False
        )
    if not _index_exists("idx_ai_history_planet_created"):
        op.create_index(
            "idx_ai_history_planet_created",
            "ai_history",
    ...
    if not _fk_exists("fk_ai_history_planet_id_planets", "ai_history"):
        op.create_foreign_key(
            "fk_ai_history_planet_id_planets",
            "ai_history",
            "planets",
            ["planet_id"],
            ["id"],
    ...
    if not _index_exists("idx_ai_queries_planet_id"):
        op.create_index(
            "idx_ai_queries_planet_id", "ai_queries", ["planet_id"], unique=False
        )
    if not _index_exists("idx_ai_queries_planet_created"):
        op.create_index(
            "idx_ai_queries_planet_created",
            "ai_queries",
            ["planet_id", "created_at"],
            unique=False,
        )
    if not _fk_exists("fk_ai_queries_planet_id_planets", "ai_queries"):
        op.create_foreign_key(
            "fk_ai_queries_planet_id_planets",
            "ai_queries",
            "planets",
            ["planet_id"],
            ["id"],
    ...
    if not _index_exists("idx_chat_messages_planet_id"):
        op.create_index(
            "idx_chat_messages_planet_id", "chat_messages", ["planet_id"], unique=False
        )
    if not _index_exists("idx_chat_messages_planet_created"):
        op.create_index(
            "idx_chat_messages_planet_created",
            "chat_messages",
            ["planet_id", "created_at"],
            unique=False,
        )
    if not _fk_exists("fk_chat_messages_planet_id_planets", "chat_messages"):
        op.create_foreign_key(
            "fk_chat_messages_planet_id_planets",
            "chat_messages",
            "planets",
            ["planet_id"],
            ["id"],
...
def downgrade() -> None:
    ...
    if _fk_exists("fk_chat_messages_planet_id_planets", "chat_messages"):
        op.drop_constraint(
            "fk_chat_messages_planet_id_planets", "chat_messages", type_="foreignkey"
        )
    ...
    if _fk_exists("fk_ai_queries_planet_id_planets", "ai_queries"):
        op.drop_constraint(
            "fk_ai_queries_planet_id_planets", "ai_queries", type_="foreignkey"
        )
    ...
    if _fk_exists("fk_ai_history_planet_id_planets", "ai_history"):
        op.drop_constraint(
            "fk_ai_history_planet_id_planets", "ai_history", type_="foreignkey"
        )
