...
from src.repositories.intelligence_signal import IntelligenceSignalRepository, get_intelligence_signal_repo
from src.schemas.intelligence_signal import IntelligenceSignalCreate, IntelligenceSignalResponse, IntelligenceSignalUpdate
...
async def list_signals(
    ...
    return await repo.get_by_planet(planet_id, category=category, include_dismissed=include_dismissed)
