...
echo "🛠️ Installing essential tools (git, curl, htop)..."
sudo apt-get install -y git curl htop ca-certificates gnupg lsb-release
...
if [ ! -f ~/.ssh/id_ed25519 ]; then
    ...
    echo "--------------------------------------------------------"
    echo "⚠️  ACTION REQUIRED: Copy the key below to your GitHub Repo (Settings -> Deploy Keys)"
    echo "--------------------------------------------------------"
